...
##----------------------------------------------------------------------------------------------------------------------
        ...
        with tab1:
            ...
            st.image('graphs\\DS1 Full bandwidth signal.png', caption='graphs\DS1 Full bandwidth signal.png')
        with tab2:
            st.header("DS2 signal")
            # LossFunctionPerEpoch = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\DS2 Full bandwidth signal.png', caption='graphs\DS2 Full bandwidth signal.png')
        with tab3:
        ...
        with tab4:
            ...
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\DS1 Flatness and Tilt 7.0.png', caption='graphs\DS1 Flatness and Tilt 7.0.png')
        with tab5:
            st.header("DS1 Flatness & Tilt 13")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\DS1 Flatness and Tilt 13.0.png', caption='graphs\DS1 Flatness and Tilt 13.0.png')
        with tab6:
            st.header("DS2 Flatness & Tilt 0")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\DS2 Flatness and Tilt 0.0.png', caption='graphs\DS2 Flatness and Tilt 0.0.png')
        with tab7:
            st.header("DS2 Flatness & Tilt 7")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\DS2 Flatness and Tilt 7.0.png', caption='graphs\DS2 Flatness and Tilt 7.0.png')
        with tab8:
            st.header("DS2 Flatness & Tilt 13")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\DS2 Flatness and Tilt 13.0.png', caption='graphs\DS2 Flatness and Tilt 13.0.png')

        tab1, tab2, tab3, tab4, tab5= st.tabs(["US1", "US2", "US3", "US4", "Python code"])
        with tab1:
            st.header("US1")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\US1 calibration measurement.png', caption='graphs\\US1 calibration measurement.png')
            st.image('graphs\\US1 nominal measurement.png', caption='graphs\\US1 nominal measurement.png')
            st.image('graphs\\US1 spurious measurement.png', caption='graphs\\US1 spurious measurement.png')
        with tab2:
            st.header("US2")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\US2 calibration measurement.png', caption='graphs\\US2 calibration measurement.png')
            st.image('graphs\\US2 nominal measurement.png', caption='graphs\\US2 nominal measurement.png')
            st.image('graphs\\US2 spurious measurement.png', caption='graphs\\US2 spurious measurement.png')
        with tab3:
            st.header("US3")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\US3 calibration measurement.png', caption='graphs\\US3 calibration measurement.png')
            st.image('graphs\\US3 nominal measurement.png', caption='graphs\\US3 nominal measurement.png')
            st.image('graphs\\US3 spurious measurement.png', caption='graphs\\US3 spurious measurement.png')
        with tab4:
            st.header("US4")
            # NN_graph = Image.open('graphs\DS1 Flatness and Tilt 0.0.png')
            st.image('graphs\\US4 calibration measurement.png', caption='graphs\\US4 calibration measurement.png')
            st.image('graphs\\US4 nominal measurement.png', caption='graphs\\US4 nominal measurement.png')
            st.image('graphs\\US4 spurious measurement.png', caption='graphs\\US4 spurious measurement.png')
        with tab5:
